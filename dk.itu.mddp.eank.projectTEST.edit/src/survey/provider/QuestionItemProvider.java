...
/**
 * This is the item provider adapter for a {@link survey.Question} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SurveyPackage.Literals.QUESTION__QUESTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addIsRequiredPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Question_isRequired_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Question_isRequired_feature", "_UI_Question_type"),
				 SurveyPackage.Literals.QUESTION__IS_REQUIRED,
				 true,
				 false,
				 false,
