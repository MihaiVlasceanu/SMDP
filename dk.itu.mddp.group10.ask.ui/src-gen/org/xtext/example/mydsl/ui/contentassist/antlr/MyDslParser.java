		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getMultipleChoiceAccess().getChoicesAssignment_12(), "rule__MultipleChoice__ChoicesAssignment_12");
					put(grammarAccess.getMultipleChoiceAccess().getChoicesAssignment_13_1(), "rule__MultipleChoice__ChoicesAssignment_13_1");
