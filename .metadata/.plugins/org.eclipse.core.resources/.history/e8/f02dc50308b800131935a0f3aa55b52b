 ...
 *   <li>{@link survey.Choice#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
...
public interface Choice extends EObject {
	 ...
	 * @see #setName(String)
	 * @see survey.SurveyPackage#getChoice_Name()
	 * @model
	 * @generated
	 */
	String getName();
	...
	/**
	 * Sets the value of the '{@link survey.Choice#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
