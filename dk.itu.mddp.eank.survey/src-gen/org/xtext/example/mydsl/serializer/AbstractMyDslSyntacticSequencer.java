...
public abstract class AbstractMyDslSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_ConstantSum_TheseKeyword_10_q;
	...
	protected void init(IGrammarAccess access) {
		...
		match_ConstantSum_TheseKeyword_10_q = new TokenAlias(false, true, grammarAccess.getConstantSumAccess().getTheseKeyword_10());
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			else if(match_ConstantSum_TheseKeyword_10_q.equals(syntax))
				emit_ConstantSum_TheseKeyword_10_q(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 *     'these'?
	 */
	protected void emit_ConstantSum_TheseKeyword_10_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
