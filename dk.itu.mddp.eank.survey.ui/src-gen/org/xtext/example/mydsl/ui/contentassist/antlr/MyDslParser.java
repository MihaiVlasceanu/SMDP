		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getStapleAccess().getMinAssignment_10(), "rule__Staple__MinAssignment_10");
					put(grammarAccess.getStapleAccess().getMaxAssignment_12(), "rule__Staple__MaxAssignment_12");
