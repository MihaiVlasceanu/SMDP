...
public abstract class AbstractMyDslSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	/**
	 * Constraint:
	 *     (name=ID question=EString? onYes=DichotomousFork? onNo=DichotomousFork?)
	 */
	...
	/**
	 * Constraint:
	 *     (name=ID question=EString? (choices+=Choice choices+=Choice*)? (Fork+=RankingSumFork Fork+=RankingSumFork*)?)
	 */
	...
	/**
	 * Constraint:
	 *     (name=ID question=EString? (Fork+=RankingSumFork Fork+=RankingSumFork*)?)
	 */
